...
function downloadAsPDF() {
  try {
    console.log("✓ PDF download initiated - opening print dialog");
    // Simply use the browser's native print functionality
    // The page is already styled for printing with @media print rules
    window.print();
  } catch (error) {
    console.error("❌ Print error:", error);
    alert("Unable to open print dialog. Please use Ctrl+P or Cmd+P to print.");
  }
}
